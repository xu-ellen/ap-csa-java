...
public class Light {
    ...
    // overload Light constructor for when colors are set manually
    public Light(short red, short green, short blue, short effect) {
        this.red = red;
        this.green = green;
        this.blue = blue;
        this.effect = effect;
    ...
    static public void main(String[] args) {
        ...
        System.out.println(light.getEffectTitle());
        System.out.println(light.getRed()); // lombok @Data automatically creates getters and hashcodes
